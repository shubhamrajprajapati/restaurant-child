...
<footer class="w-full" id="contact-us">
        ...
        <div
            ...
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                ...
                <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">
                    Dinsdag tot Zondag <br>
                    17.00 uur - 22.00 uur <br>
                    xxxyyyzzz
                </p>
            </div>
            <!--End Col-->
            @if ($telephones)
                <div class="lg:mx-auto text-left">
                    ...
                    <ul class="text-base  transition-all duration-500">
                        @foreach ($telephones as $telephone)
                            <li class="mb-6">
                                <a href="tel:{{ $telephone }}" class="text-gray-600 hover:text-gray-900">
                                    {{ $telephone }}
                                </a>
                            </li>
                        @endforeach
                ...
                <div class="lg:mx-auto text-left">
                    ...
                    <ul class="text-base  transition-all duration-500">
                        @foreach ($emails as $email)
                            <li class="mb-6">
                                <a href="mailto:{{ $email }}" class="text-gray-600 hover:text-gray-900">
                                    {{ $email }}
                                </a>
                            </li>
                        @endforeach
            ...
            @if ($addresses)
                <div class="lg:mx-auto text-left">
                    ...
                    <ul class="text-base  transition-all duration-500">
                        <li class="mb-6">
                            <a href="{{ $geo_location_link ?? 'javascript:;' }}"
