...
class RollingMessagePolicy
{
     ...
     */
    public function view(User $user, RollingMessage $rollingMessage): bool
    {
        return $user->role->isAdmin();
    }
     ...
     */
    public function update(User $user, RollingMessage $rollingMessage): bool
    {
        return $user->role->isAdmin();
    }
     ...
     */
    public function delete(User $user, RollingMessage $rollingMessage): bool
    {
        return $user->role->isAdmin();
    }
     ...
     */
    public function restore(User $user, RollingMessage $rollingMessage): bool
    {
        return $user->role->isAdmin();
    }
